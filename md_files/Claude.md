...
│   ├── data/
│   │   ├── raw/
│   │   │   ├── resume-classification-dataset.csv       ← Kaggle resume dataset (download manually)
│   │   │   ├── skills.csv               ← Temp dictionary type file with some skill use for skill extraction 
...
│   ├── models/
│   │   ├── saved/
│   │   │   ├── logistic_model.pkl       ← Trained Logistic Regression classifier(I have it as resume_classifier.pkl)(Available rightnow)
│   │   │   ├── naive_bayes_model.pkl    ← Trained Naive Bayes classifier
│   │   │   ├── random_forest_model.pkl  ← [NEW] Trained Random Forest classifier
│   │   │   └── tfidf_vectorizer.pkl     ← Fitted TF-IDF vectorizer (shared)(Available right now)
...
# Code I have done for Backend Server
...
// ES MODULE EXPORT (IMPORTANT FIX)
...
# ml_service/data/raw/skills.csv
Skill
Python
Java
C#
