...
export default function Register() {
  ...
  useEffect(() => {
    const styleId = "register-light-theme-overrides";
    ...
    if (!dark) {
      if (!existing) {
        ...
        style.id = styleId;
        style.textContent = `
          /* Light theme overrides for RegisterPage (only when dark=false) */
          .register-root {
            background: #f5f5f5 !important;
          }
          .register-root .reg-card {
            border-color: rgba(0,0,0,0.1) !important;
            box-shadow: 0 40px 100px rgba(0,0,0,0.1) !important;
          }
          .register-root .reg-left {
            background: linear-gradient(145deg, #e8f5e9 0%, #c8e6c9 40%, #a5d6a7 100%) !important;
          }
          .register-root .reg-left * {
            color: #1a2e1a !important;
          }
          .register-root .reg-left .left-badge,
          .register-root .reg-left .step,
          .register-root .reg-left .step-active {
            background: rgba(0,0,0,0.05) !important;
            border-color: rgba(0,0,0,0.1) !important;
            color: #1a2e1a !important;
          }
          .register-root .reg-left .step-num {
            background: rgba(0,0,0,0.1) !important;
            border-color: rgba(0,0,0,0.15) !important;
            color: #1a2e1a !important;
          }
          .register-root .reg-left .step-num-active {
            background: #fff !important;
            color: #0a3320 !important;
          }
          .register-root .reg-left .stat-divider {
            background: rgba(0,0,0,0.1) !important;
          }
          .register-root .reg-right {
            background: #ffffff !important;
          }
          .register-root .reg-right input,
          .register-root .reg-right button,
          .register-root .reg-right .oauth-btn,
          .register-root .reg-right .submit-btn {
            background: #f0f0f0 !important;
            border-color: #ddd !important;
            color: #111 !important;
          }
          .register-root .reg-right input:focus {
            border-color: #22c55e !important;
          }
          .register-root .reg-right .oauth-btn:hover {
          ...
          .register-root .reg-right .submit-btn:disabled {
            opacity: 0.6 !important;
          }
          .register-root .reg-right a {
            color: #000 !important;
          }
          .register-root .reg-right h2 {
            color: #111 !important;
          }

          /* FIX: password strength bars – set parent background, do NOT override individual bar colors */
          .register-root .reg-right .strength-bars {
            background: #e0e0e0 !important;
            border-radius: 2px;
          }
          .register-root .reg-right .or-line {
            background: #ccc !important;
          }
          .register-root .reg-right .or-text,
          .register-root .reg-right .sub-heading,
          .register-root .reg-right .login-link {
            color: #666 !important;
          }
        `;
  ...
  return (
    <div style={s.root} className="register-root">
      <Navbar />
